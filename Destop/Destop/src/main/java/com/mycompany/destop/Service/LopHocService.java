...
public class LopHocService {
    ...
    public List<LopHoc> getAllLopHocApi(String token) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/lopHoc/getAll"; // Đảm bảo URL này đúng
    ...
    public List<LopHoc> getAllLopHocTrueApi(String token) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/lopHoc/getAllTrue"; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public List<LopHoc> getAllLopHocByIdKhoaApi(String token, Long idKhoa) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/lopHoc/getByKhoa/" + idKhoa; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public List<LopHoc> getAllLopHocByIdGVApi(String token, Long idGV) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/lopHoc/getByGv/" + idGV; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public List<LopHoc> getAllLopHocLikeNameApi(String token, String name) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/lopHoc/getLikeNameLop/" + name; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public List<LopHoc> getAllLopHocLikeNameGVApi(String token, String name) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/lopHoc/getLikeNameGV/" + name; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public List<LopHoc> getAllLopHocLikeNameKhoaApi(String token, String name) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/lopHoc/getLikeNameKhoa/" + name; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public LopHoc UpdateLopHoc(String token, LopHoc lopHoc, Long idKhoa, Long idGV, Long idLop) throws Exception {
        String apiUrl = "http://54.254.94.80:8080/lopHoc/create/" + idKhoa + "/" + idGV + "/" + idLop; // URL API
    ...
    public LopHoc createLopHoc(String token, LopHoc lopHoc, Long idKhoa, Long idGV) throws Exception {
        String apiUrl = "http://54.254.94.80:8080/lopHoc/createLopDestop/" + idKhoa + "/" + idGV;
        HttpURLConnection conn = null;
    ...
    public LopHoc loadLopHocById(String token, Long idLop) throws Exception {
        String apiUrl = "http://54.254.94.80:8080/lopHoc/getLop/" + idLop; // URL API với tham số ID
        HttpURLConnection conn = null;
    ...
    public List<BaiTest> loadBaiTestByIdLopxetTuyenFalse(String token, Long idLop) throws Exception {
        String apiUrl = "http://54.254.94.80:8080/baitest/getBaiTestofLopXetFalse/" + idLop; // URL API với tham số ID
        HttpURLConnection conn = null;
    ...
    public Boolean aceptBaiTestByIdLopxetTuyenFalse(String token, List<Long> list) throws Exception {
        String apiUrl = "http://54.254.94.80:8080/baitest/AceptBaiTestofLopXetFalse"; // URL API
        HttpURLConnection conn = null;
    ...
    public Boolean CancelBaiTestofLopXetFalse(String token, List<Long> list) throws Exception {
        String apiUrl = "http://54.254.94.80:8080/baitest/CancelBaiTestofLopXetFalse"; // URL API
        HttpURLConnection conn = null;
    ...
    public LopHoc deleteLopHoc(String token, Long id) throws Exception {
        String apiUrl = "http://54.254.94.80:8080/lopHoc/delete/" + id; // URL endpoint của API xóa lớp học
        HttpURLConnection conn = null;
    ...
    public List<BuoiHoc> getAllBuoiHocByLopApi(String token, Long idLop) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/buoihoc/getbuoiHocByLop/" + idLop; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public BuoiHoc getBuoiHocById(String token, Long id) throws Exception {
        String apiUrl = "http://54.254.94.80:8080/buoihoc/getBuoiById/" + id; // URL endpoint của API xóa lớp học
        HttpURLConnection conn = null;
    ...
    public BuoiHoc CreateBuoiHoc(String token, BuoiHoc buoiHoc, Long idLop) throws Exception {
        String apiUrl = "http://54.254.94.80:8080/buoihoc/createBuoiHoc/" + idLop; // URL API
        HttpURLConnection conn = null;
    ...
    public List<HocVien> getAllHocVienByLopApi(String token, Long idLop) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/lopHoc/getByLop/" + idLop; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
