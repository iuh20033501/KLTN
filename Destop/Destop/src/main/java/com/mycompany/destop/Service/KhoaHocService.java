...
public class KhoaHocService {
    ...
    public List<KhoaHoc> getAllTrueKhoaHocApi(String token) throws Exception {
        String profileUrl = "http://localhost:8081/khoahoc/getAllTrue"; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
     ...
     public List<KhoaHoc> getAllKhoaHocActiveTrue(String token,String name) throws Exception {
        String profileUrl = "http://localhost:8081/khoahoc/getListActiveTrueLikeName/"+name; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
     ...
     public List<KhoaHoc> getAllKhoaHocLikeName(String token,String name) throws Exception {
        String profileUrl = "http://localhost:8081/khoahoc/getListLikeName/"+name; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
     ...
     public List<KhoaHoc> getAllKhoaHocInYear(String token,String year) throws Exception {
        String profileUrl = "http://localhost:8081/khoahoc/getListInYear/"+year; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
