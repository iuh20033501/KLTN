...
public class KhoaHocService {
    ...
    public List<KhoaHoc> getAllKhoaHocApi(String token) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/khoahoc/getAll"; // Đảm bảo URL này đúng
    ...
    public List<KhoaHoc> getAllTrueKhoaHocApi(String token) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/khoahoc/getAllTrue"; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
     ...
     public List<KhoaHoc> getAllKhoaHocActiveTrue(String token,String name) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/khoahoc/getListActiveTrueLikeName/"+name; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
     ...
     public List<KhoaHoc> getAllKhoaHocLikeName(String token,String name) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/khoahoc/getListLikeName/"+name; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
     ...
     public List<KhoaHoc> getAllKhoaHocInYear(String token,String year) throws Exception {
        String profileUrl = "http://54.254.94.80:8080/khoahoc/getListInYear/"+year; // Đảm bảo URL này đúng
        URL url = new URL(profileUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public KhoaHoc loadKhoaHocById(String token, Long idKhoa) throws Exception {
        String apiUrl = "http://54.254.94.80:8080/khoahoc/findKhoa/" + idKhoa; // URL API với tham số ID
    ...
    public KhoaHoc deleteKhoaHocApi(String token, Long idKhoa) throws Exception {
        String apiUrl = "http://54.254.94.80:8080/khoahoc/xoaKhoa/" + idKhoa; // URL API với tham số ID
        HttpURLConnection conn = null;
    ...
    public Boolean createKhoaHocFromClient(String token, KhoaHoc khoaHoc) throws Exception {
        String url = "http://54.254.94.80:8080/khoahoc/create"; // Đảm bảo URL này chính xác
        HttpURLConnection conn = null;
