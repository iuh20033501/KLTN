...
import { View, Text, StyleSheet, TextInput, Image, TouchableOpacity, Platform, Modal, ScrollView, ImageBackground } from 'react-native';
...
export default function EditProfileScreen({ navigation }: { navigation: any }) {
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            const response = await http.put(`giangVien/update/${user.u.idUser}`, {
