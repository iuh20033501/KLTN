...
export default function ResultTeacherScreen({ navigation, route }: { navigation: any; route: any }) {
    ...
    const renderClassCard = ({ item }: { item: ClassInfo }) => (
        <TouchableOpacity style={styles.card}   onPress={() => navigation.navigate('ResultTeacherDetailScreen', {
            idUser,role,
