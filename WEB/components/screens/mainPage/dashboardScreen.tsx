        ...
        <View style={styles.studentOverviewContainer}>
          <View style={styles.studentInfoCard}>
            ...
            <View style={styles.studentDetails}>
              ...
              <Text style={styles.studentLabel}>Lớp học: <Text style={styles.studentData}></Text></Text>
              <Text style={styles.studentLabel}>Khóa học: <Text style={styles.studentData}></Text></Text>
            </View>
          </View>
