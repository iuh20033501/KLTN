...
export default function StudentExamClassesScreen({ navigation, route }: { navigation: any; route: any }) {
        ...
        <View style={styles.container}>
            ...
            {isLoading ? (
                ...
                <FlatList
                    data={classes}
                    renderItem={({ item }) => (
                        <TouchableOpacity style={styles.exerciseButton} onPress={() => navigation.navigate('StudentExamScreen', { idLopHoc: item.idLopHoc, idUser, tenLopHoc: item.tenLopHoc })}>
