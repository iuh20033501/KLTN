...
const TermsAndConditions = () => {
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={{fontSize:26,fontWeight:'bold',textAlign:'center',marginBottom:20}}>Điều khoản sử dụng </Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Ứng dụng này được thiết kế cho người dùng từ độ tuổi 11 đến 15 có nhu cầu học tiếng Anh. Người dùng dưới 18 tuổi phải có sự đồng ý của phụ huynh hoặc người giám hộ hợp pháp trước khi sử dụng ứng dụng. Nếu bạn là phụ huynh hoặc người giám hộ hợp pháp, bạn có trách nhiệm giám sát việc sử dụng ứng dụng của trẻ em dưới quyền quản lý của bạn.
        </Text>
      </View>
